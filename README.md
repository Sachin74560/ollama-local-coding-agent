...
<p>
  <img src="https://img.shields.io/badge/tests-219%20passing-2ea44f" alt="tests" />
...
- ✅ **Battle-tested.** 219 automated tests, plus a mandatory secret scan on every run.
...
**219 tests · 0 dependencies · no build step · 100% offline · Apache-2.0 licensed.**
